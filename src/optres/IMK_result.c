...
static IMK_Ptr PtrToStrR(IMK_Ptr ptr) { return IMK_ToStrP(ptr, NULL, IMK_FORCE_HEAP); }
...
IMK_RESULT_DEFINE(IMK_ResUInt, unsigned int, IMK_Ptr, PtrToStrR,
                  PtrDropR)
IMK_RESULT_DEFINE(IMK_ResUShort, unsigned short, IMK_Ptr, PtrToStrR,
                  PtrDropR)
IMK_RESULT_DEFINE(IMK_ResULong, unsigned long, IMK_Ptr, PtrToStrR,
                  PtrDropR)
IMK_RESULT_DEFINE(IMK_ResUChar, unsigned char, IMK_Ptr, PtrToStrR,
                  PtrDropR)
